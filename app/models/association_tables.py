...
class UsersQuests(Base):
    user_id: Mapped[int] = Column(ForeignKey('usertable.id', ondelete='CASCADE'), primary_key=True)
    quest_id: Mapped[int] = Column(ForeignKey('quest.id', ondelete='CASCADE'), primary_key=True)
...
#     user_id: Mapped[int] = Column(ForeignKey('usertable.id', ondelete='CASCADE'), primary_key=True)
#     skill_id: Mapped[int] = Column(ForeignKey('skill.id', ondelete='CASCADE'), primary_key=True)
...
#         ForeignKey('achievement.id', ondelete='CASCADE'), primary_key=True
#     )
