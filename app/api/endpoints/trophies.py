...
@router.get('/', response_model=list[trophies.Trophy], status_code=http_status.HTTP_200_OK)
...
def set_trophy_hash(id: int, request_body: trophies.TrophyRequest, db: Session = Depends(deps.get_db)):
